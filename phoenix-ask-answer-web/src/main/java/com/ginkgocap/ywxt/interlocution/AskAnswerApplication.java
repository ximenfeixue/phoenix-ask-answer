...
package com.ginkgocap.ywxt.interlocution;
...
@Configuration
@ComponentScan(basePackages="com.ginkgocap.ywxt.interlocution")
@ImportResource("classpath:applicationContext.xml")
public class AskAnswerApplication {

	public static void main(String[] args) throws Exception {
		
		//SpringApplication.run(SampleJettyApplication.class, args);
		SpringApplication.run(AskAnswerApplication.class, args);
